...
google.maps.Polygon.prototype.GetIndexByPosition = function (point) {
    var j = 0;
    var positionIndex = -1;
    var oddNodes = false;
    var x = point.lng();
    ...
    //        if (((this.getPath().getAt(i).lat() <= y) && (this.getPath().getAt(j).lat() >= y))
    //            || ((this.getPath().getAt(j).lat() <= y) && (this.getPath().getAt(i).lat() >= y))) {
    //            var dist = this.getPath().getAt(i).distanceFrom(point);
    //            if(dist < 100)
    //                positionIndex = i;
    //            //if (((this.getPath().getAt(i).lng() <= x) && (this.getPath().getAt(j).lng() >= x))
    //            //|| ((this.getPath().getAt(j).lng() <= x) && (this.getPath().getAt(i).lng() >= x)))
    //            //{
    //            //    positionIndex = i;
    //            //}
    //        } 
...
google.maps.Polygon.prototype.DistanceFrom = function (index) {
    var dist = 0;
...
google.maps.Polyline.prototype.GetIndexByPosition = google.maps.Polygon.prototype.GetIndexByPosition;
google.maps.Polyline.prototype.Area = google.maps.Polygon.prototype.Area;
google.maps.Polyline.prototype.Distance = google.maps.Polygon.prototype.Distance;
google.maps.Polyline.prototype.DistanceFrom = google.maps.Polygon.prototype.DistanceFrom;
